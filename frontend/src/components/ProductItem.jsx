...
const ProductItem = ({
  ...
  return (
    <Link
      className="text-(--main-text-color) cursor-pointer"
    ...
    >
      ...
      <p className="pt-3 pb-0.5 text-xs text-(--main-text-color) uppercase tracking-widest">
        {category_name}
      </p>
      <p className="pt-0.5 text-sm text-(--main-text-color) font-medium">
        {name}
      </p>
      <p className="text-sm font-bold text-(--main-text-color)">
        {price}
        {currency}
      </p>
