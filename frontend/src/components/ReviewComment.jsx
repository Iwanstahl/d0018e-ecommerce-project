    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-1000 flex items-center justify-center p-4">
      <div className="bg-(--main-text-color) text-(--second-text-color) w-full max-w-md p-8 shadow-2xl border border-white/10">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold uppercase text-(--second-text-color) tracking-tighter">
              Add Review
            </h2>
            <p className="text-[10px] uppercase text-(--second-text-color) opacity-50 tracking-widest">
              {productName}
            </p>
          </div>
          <button
        ...
        <div className="space-y-6">
          {/* Raiting selection */}
          <div>
            <label className="text-[10px] uppercase font-bold mb-3 block text-(--second-text-color">
              Rating
            </label>
